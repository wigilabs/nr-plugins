...
def main(argv):
    ...
    while True:
        ...
        content=content.replace('[{ "eventType" : "splunkAuthLogs", "name":"_bkt"},{"name":"_cd"},{"name":"_indextime"},{"name":"_raw"},{"name":"_serial"},{"name":"_si"},{"name":"_sourcetype"},{"name":"_time"},{"name":"host"},{"name":"index"},{"name":"linecount"},{"name":"source"},{"name":"sourcetype"},{"name":"splunk_server"}],"results":',' ')
        content=content[:-19]
        content=content.replace('"_si":["debian-splunk","main"],','')
        content=content.replace('[{','[{ "eventType" : "splunkAuthLogs", ')
        ...
        content=content.decode('utf-8')[307:]
        print(content)
        val=("movii",content)
